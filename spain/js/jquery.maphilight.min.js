(function (G) {
    ...
    if (J) {
        ...
        C = function (O) {
            var P = G('<canvas style="width:' + O.width + "px;height:" + O.height + 'px; margin-top:2px"></canvas>').get(0);
    ...
    G.fn.maphilight = function (Q) {
        ...
        return this.each(function () {
            ...
            T.append('<canvas id="canvas-empty" style="margin-top:2px;margin-left:0px; width:' + this.width + "px;height:" + this.height + 'px;" width="' + this.width + '" height="' + this.height + '"></canvas>');
            T.append(W);
            V = C(this);
            G(V).css(I);
