...
<h2 class="render-title"><?php _e('Header logo', 'usa'); ?></h2>
<?php if( is_writable( WebThemes::newInstance()->getCurrentThemePath() . "images/") ) { ?>
    <?php if(file_exists( WebThemes::newInstance()->getCurrentThemePath() . "images/logo.jpg" ) ) { ?>
        <h3 class="render-title"><?php _e('Preview', 'usa') ?></h3>
    ...
    <?php } else { ?>
        <div class="flashmessage flashmessage-warning flashmessage-inline" style="display: block;">
            <p><?php _e("No logo has been uploaded yet", 'usa'); ?></p>
        </div>
    <?php } ?>
    <h2 class="render-title separate-top"><?php _e('Upload logo', 'usa') ?></h2>
    <p>
    ...
    <div class="flashmessage flashmessage-error" style="display: block;">
        <p>
            <?php
                ...
                $msg .= __("OSClass can't upload the logo image from the administration panel.", 'usa') . ' ';
                $msg .= __("Please make the aforementioned image folder writable.", 'usa') . ' ';
                echo $msg;
            ?>
        </p>
        <p>
