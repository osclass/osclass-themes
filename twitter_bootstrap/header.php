        ...
        <div class="container">
            <div class="row login_nav">
                <ul class="unstyled">
                    ...
                    <li class="languages">
                        &middot;
                        <a class="active" href="#"><?php _e('Language', 'twitter_bootstrap'); ?> <?php while ( osc_has_web_enabled_locales() ) { if( osc_locale_code() == osc_current_user_locale()) { ?>(<?php echo osc_locale_field('s_short_name') ; ?>)<?php } } ?></a>
                        <ul>
                        <?php $i = 0 ;  ?>
                        <?php osc_goto_first_locale() ; ?>
