        ...
        <div class="container container-fluid search">
            ...
            <div class="sidebar well">
                <form action="<?php echo osc_base_url(true); ?>" method="get">
                    ...
                    <fieldset>
                        <h4><?php _e('Your search', 'twitter_bootstrap') ; ?></h4>
                        <div class="clearfix">
                            <input type="text" name="sPattern" id="query" value="<?php echo osc_search_pattern() ; ?>" />
                        </div>
                    </fieldset>
                    <fieldset>
                        <h4><?php _e('City', 'twitter_bootstrap') ; ?></h4>
                        <div class="clearfix">
                    ...
                    <fieldset>
                        <h4><?php _e('Categories', 'twitter_bootstrap') ; ?></h4>
                        <div class="clearfix">
                    ...
                    ?>
                    <div class="clearfix">
                        <button class="btn" type="submit"><?php _e('Apply', 'twitter_bootstrap') ; ?></button>
                    </div>
                </form>
                <?php osc_alert_form() ; ?>
            </div>
