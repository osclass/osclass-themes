...
<?php if( is_writable( WebThemes::newInstance()->getCurrentThemePath() . "images/") ) { ?>
    ...
    <?php } else { ?>
        <div class="flashmessage flashmessage-warning flashmessage-inline" style="display: block;">
            <p><?php _e("No logo has been uploaded yet", 'italia'); ?></p>
        </div>
    <?php } ?>
    ...
    <div class="flashmessage flashmessage-error" style="display: block;">
        <p>
            <?php
                ...
                $msg .= __("OSClass can't upload the logo image from the administration panel.", 'italia') . ' ';
                $msg .= __("Please make the aforementioned image folder writable.", 'italia') . ' ';
                echo $msg;
            ?>
        </p>
        <p>
