        ...
        <div class="content item">
            ...
            <div id="main">
                ...
                <div id="useful_info">
                    ...
                    <ul>
                        <li><?php _e('Avoid scams by acting locally or paying with PayPal', 'italia'); ?></li>
                        <li><?php _e('Never pay with Western Union, Moneygram or other anonymous payment services', 'italia'); ?></li>
                        <li><?php _e('Don\'t buy or sell outside of your country. Don\'t accept cashier cheques from outside your country', 'italia'); ?></li>
                        <li><?php _e('This site is never involved in any transaction, and does not handle payments, shipping, guarantee transactions, provide escrow services, or offer "buyer protection" or "seller certification"', 'italia') ; ?></li>
                    </ul>
                </div>
            ...
            <div id="sidebar">
                ...
                <div id="contact">
                    ...
                    <?php if( osc_item_is_expired () ) { ?>
                        <p>
                            <?php _e('The listing is expired. You cannot contact the publisher.', 'italia') ; ?>
                        </p>
                    <?php } else if( ( osc_logged_user_id() == osc_item_user_id() ) && osc_logged_user_id() != 0 ) { ?>
                        <p>
                            <?php _e("It's your own listing, you cannot contact the publisher.", 'italia') ; ?>
                        </p>
                    <?php } else if( osc_reg_user_can_contact() && !osc_is_web_user_logged_in() ) { ?>
                        <p>
                            <?php _e("You must login or register a new free account in order to contact the advertiser", 'italia') ; ?>
                        </p>
                        <p class="contact_button">
