            ...
            <div id="main">
                <div class="ad_list">
                    <div id="list_head">
                        <div class="inner">
                            <h1>
                                <strong><?php _e('Search results', 'italia') ; ?></strong>
                            </h1>
                            <p class="see_by">
                                <?php _e('Sort by', 'italia'); ?>:
                                <?php $i = 0 ; ?>
                    ...
                    <?php if(osc_count_items() == 0) { ?>
                        <p class="empty" ><?php printf(__('There are no results matching "%s"', 'italia'), osc_search_pattern()) ; ?></p>
                    <?php } else { ?>
                ...
                <div class="filters">
                    <form action="<?php echo osc_base_url(true); ?>" method="get" onsubmit="return doSearch()">
                        ...
                        <fieldset class="box show_only">
                            ...
                            <h3><strong><?php _e('Show only', 'italia') ; ?></strong></h3>
                            <div class="row checkboxes">
                                <ul>
                                    <li>
                                        <input type="checkbox" name="bPic" id="withPicture" value="1" <?php echo (osc_search_has_pic() ? 'checked="checked"' : ''); ?> />
                                        <label for="withPicture"><?php _e('Show only listings with pictures', 'italia') ; ?></label>
                                    </li>
                                </ul>
                            </div>
                            <?php } ?>
                        ...
                        <button type="submit"><?php _e('Apply', 'italia') ; ?></button>
                    </form>
                    <?php osc_alert_form() ; ?>
                </div>
            </div>
                ...
                $(function() {
                    ...
                    $( "#sCity" ).autocomplete({
                        ...
                        select: function( event, ui ) {
                            log( ui.item ?
                                "<?php _e('Selected', 'italia'); ?>: " + ui.item.value + " aka " + ui.item.id :
                                "<?php _e('Nothing selected, input was', 'italia'); ?> " + this.value );
                        }
                    });
                });
