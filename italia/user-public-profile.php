...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="<?php echo str_replace('_', '-', osc_current_user_locale()); ?>">
    ...
    <body>
        ...
        <div class="content item user_public_profile">
            <div id="item_head">
                <div class="inner">
                    <h1><?php echo sprintf(__('%s\'s profile', 'italia'), osc_user_name()); ?></h1>
                </div>
            </div>
            <div id="main">
                <br />
                <div id="description">
                <h2><?php _e('Profile', 'italia'); ?></h2>
                    <ul id="user_data">
                        <li><?php _e('Full name', 'italia'); ?>: <?php echo osc_user_name(); ?></li>
                        <li><?php _e('Address', 'italia'); ?>: <?php echo $address; ?></li>
                        <li><?php _e('Location', 'italia'); ?>: <?php echo $location; ?></li>
                        <li><?php _e('Website', 'italia'); ?>: <?php echo osc_user_website(); ?></li>
                        <li><?php _e('User Description', 'italia'); ?>: <?php echo osc_user_info(); ?></li>
                    </ul>
                </div>
                <div id="description" class="latest_ads">
                    <h2><?php _e('Latest listings', 'italia'); ?></h2>
