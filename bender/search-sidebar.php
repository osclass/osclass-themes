            ...
            <div class="row ">
                ...
                <ul class="category">
                    ...
                    <?php while(osc_has_categories()) { ?>
                        <?php $parentSelected=false; if (in_array(osc_category_id(), osc_search_category()) || in_array(osc_category_slug()."/", osc_search_category()) || in_array(osc_category_slug(), osc_search_category()) || count(osc_search_category())==0 ){ $parentSelected=true;} ?>
