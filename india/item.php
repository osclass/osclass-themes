        ...
        <div class="content item">
            ...
            <div id="sidebar">
                ...
                <div id="contact">
                    ...
                    <?php if( osc_item_is_expired () ) { ?>
                        <p>
                            <?php _e('The listing is expired. You cannot contact the publisher.', 'india') ; ?>
                        </p>
                    <?php } else if( ( osc_logged_user_id() == osc_item_user_id() ) && osc_logged_user_id() != 0 ) { ?>
                        <p>
                            <?php _e("It's your own listing, you cannot contact the publisher.", 'india') ; ?>
                        </p>
                    <?php } else if( osc_reg_user_can_contact() && !osc_is_web_user_logged_in() ) { ?>
                        <p>
                            <?php _e("You must login or register a new free account in order to contact the advertiser", 'india') ; ?>
                        </p>
                        <p class="contact_button">
