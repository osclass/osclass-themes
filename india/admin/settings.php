<?php if( !osc_get_preference('footer_link', 'india_theme') ) { ?>
<form name="_xclick" action="https://www.paypal.com/in/cgi-bin/webscr" method="post">
    ...
    <input type="hidden" name="return" value="<?php echo osc_admin_render_theme_url('oc-content/themes/india/admin/settings.php'); ?>">
    ...
    <div id="flashmessage" class="flashmessage flashmessage-inline flashmessage-warning" style="color: #505050; display: block; ">
        <p><?php _e('I would like to contribute to the development of OSClass with a donation of', 'india'); ?> <select name="amount" class="input-medium">
...
<?php } ?>
<h2 class="render-title <?php echo (osc_get_preference('footer_link', 'india_theme') ? '' : 'separate-top'); ?>"><?php _e('Theme settings', 'india'); ?></h2>
    ...
    <fieldset>
        <div class="form-horizontal">
            <div class="form-row">
                ...
                <div class="form-controls"><input type="text" class="xlarge" name="keyword_placeholder" value="<?php echo osc_esc_html( osc_get_preference('keyword_placeholder', 'india_theme') ); ?>"></div>
            </div>
            <div class="form-row">
                <div class="form-label"><?php _e('Footer link', 'india'); ?></div>
                <div class="form-controls">
                    <div class="form-label-checkbox"><input type="checkbox" name="footer_link" value="1" <?php echo (osc_get_preference('footer_link', 'india_theme') ? 'checked' : ''); ?> > <?php _e('I want to help OSClass linking to <a href="http://osclass.org/" target="_blank">osclass.org</a> from my site with the following text:', 'india'); ?></div>
