                    ...
                    <input type="hidden" name="secret" value="<?php echo osc_item_secret() ;?>" />
                        <div class="box general_info">
                            ...
                            <div class="row">
                                ...
                                <?php ItemForm::category_select(null, null, __('Select a category', 'brasil')); ?>
                            </div>
                            <div class="row">
                        ...
                        <div class="box location">
                            <h2><?php _e('Location', 'brasil'); ?></h2>
                            <div class="row">
                                <label><?php _e('Country', 'brasil'); ?></label>
                                <?php ItemForm::country_select() ; ?>
                            </div>
                            <div class="row">
                                <label><?php _e('Region', 'brasil'); ?></label>
                                <?php ItemForm::region_text() ; ?>
                            </div>
                            <div class="row">
                                <label><?php _e('City', 'brasil'); ?></label>
                                <?php ItemForm::city_text() ; ?>
                            </div>
                            <div class="row">
                                <label><?php _e('City area', 'brasil'); ?></label>
                                <?php ItemForm::city_area_text() ; ?>
                            </div>
                            <div class="row">
                                <label><?php _e('Address', 'brasil'); ?></label>
